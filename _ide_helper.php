...
namespace Nwidart\Modules {
    ...
    class FileRepository {
        /**
         * @see \App\Providers\ModuleCompatibilityServiceProvider::boot()
         * @param string $alias
         * @static
         */
        public static function findByAlias($alias)
        {
            return \Nwidart\Modules\FileRepository::findByAlias($alias);
        }
    ...
    class Module {
        ...
        {
            return \Nwidart\Modules\Module::getAlias();
        }
...
namespace  {
    ...
    class Eloquent {        /**
         ...
         *
         * @param \Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<static> $query
         * @return \Illuminate\Database\Eloquent\Builder<static>
         * @static
         */
    ...
    class Helper extends \App\Misc\Helper {}
}

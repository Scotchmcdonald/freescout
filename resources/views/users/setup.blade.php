<x-guest-layout>
    <div class="min-h-screen flex items-center justify-center bg-neutral-100 py-12 px-4 sm:px-6 lg:px-8">
                ...
                <div class="rounded-md shadow-sm space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="first_name" value="{{ $user->first_name }}" disabled
                               class="mt-1 block w-full px-3 py-2 bg-neutral-100 border border-neutral-300 rounded-md text-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email', $user->email) }}" required
                               class="mt-1 block w-full px-3 py-2 border border-neutral-300 rounded-md focus:ring-primary-500 focus:border-primary-500">
                        @error('email')
                    ...
                    <div>
                        <label for="password" class="block text-sm font-medium text-neutral-700">
                            {{ __('Password') }} <span class="text-danger-500">*</span>
                        </label>
                        ...
                        @error('password')
                            <p class="mt-1 text-sm text-danger-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-neutral-500">{{ __('Minimum 8 characters') }}</p>
                    </div>

                    <!-- Password Confirmation -->
                    <div>
                        <label for="password_confirmation" class="block text-sm font-medium text-neutral-700">
                            {{ __('Confirm Password') }} <span class="text-danger-500">*</span>
                        </label>
                    ...
                    <!-- Job Title -->
                    <div>
                        <label for="job_title" class="block text-sm font-medium text-neutral-700">
                            {{ __('Job Title') }}
                        </label>
                    ...
                    <!-- Timezone -->
                    <div>
                        <label for="timezone" class="block text-sm font-medium text-neutral-700">
                            {{ __('Timezone') }} <span class="text-danger-500">*</span>
                        </label>
                    ...
                    <!-- Time Format -->
                    <div>
                        <label for="time_format" class="block text-sm font-medium text-neutral-700">
                            {{ __('Time Format') }} <span class="text-danger-500">*</span>
                        </label>
                    ...
                    <!-- Photo Upload -->
                    <div>
                        <label for="photo_url" class="block text-sm font-medium text-neutral-700">
                            {{ __('Profile Photo') }}
                        </label>
                        ...
                        @error('photo_url')
                            <p class="mt-1 text-sm text-danger-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-neutral-500">{{ __('JPEG, PNG, JPG or GIF (max 2MB)') }}</p>
                    </div>
                </div>

                        ...
                        <div class="space-y-6">
                            ...
                            @if(auth()->check() && auth()->user()->isAdmin())
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-neutral-500 {{ $currentType == 2 ? 'hidden' : '' }}" id="type-hint-internal">Internal staff have access to mailboxes and helpdesk tools.</p>
                                    <p class="mt-1 text-sm text-neutral-500 {{ $currentType != 2 ? 'hidden' : '' }}" id="type-hint-external">External clients access the customer portal only.</p>
                                </div>

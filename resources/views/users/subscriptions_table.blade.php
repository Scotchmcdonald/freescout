    ...
    <table class="min-w-full divide-y divide-gray-200">
        <thead class="bg-neutral-50">
            <tr>
                ...
                <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-neutral-700 uppercase tracking-wider w-24">
                    {{ __('Email') }}<br>
                    <input type="checkbox" 
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                <td class="px-6 py-4 text-sm text-neutral-900">{{ __('There is a new conversation') }}</td>
                <td class="px-6 py-4 text-center">
                    <input type="checkbox" 
                           ...
                           class="rounded border-neutral-300 text-primary-600 focus:ring-primary-500 subscription-email">
                </td>
                <td class="px-6 py-4 text-center">
                    <input type="checkbox" 
                           ...
                           value="{{ Subscription::EVENT_NEW_CONVERSATION }}"
                           class="rounded border-neutral-300 text-primary-600 focus:ring-primary-500 subscription-browser">
                </td>
                <td class="px-6 py-4 text-center">
                    <input type="checkbox" 
                           ...
                           value="{{ Subscription::EVENT_NEW_CONVERSATION }}"
                           @if(!$mobile_available) disabled @endif
                           class="rounded border-neutral-300 text-primary-600 focus:ring-primary-500 subscription-mobile">
                </td>
            </tr>
            ...
            <tr>
                <td class="px-6 py-4 text-sm text-neutral-900">{{ __('A conversation is assigned to someone else') }}</td>
                <td class="px-6 py-4 text-center">
                    <input type="checkbox" 
            ...
            <tr class="bg-neutral-50">
                <th colspan="4" class="px-6 py-3 text-left text-xs font-medium text-neutral-700 uppercase tracking-wider">
                    @if($person !== __('me'))
            ...
            <tr>
                <td class="px-6 py-4 text-sm text-neutral-900">{{ __('To an unassigned conversation') }}</td>
                <td class="px-6 py-4 text-center">
                    <input type="checkbox" 
            ...
            <tr>
                <td class="px-6 py-4 text-sm text-neutral-900">{{ __('To a conversation assigned to someone else') }}</td>
                <td class="px-6 py-4 text-center">
                    <input type="checkbox" 

        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-neutral-900">
                    ...
                    <div class="mb-6 flex justify-between items-end">
                        <div>
                            <h3 class="text-lg font-medium text-neutral-900 mb-2">{{ __('Select Theme') }}</h3>
                        ...
                        <div>
                            <a href="{{ route('themes.editor.index') }}" class="text-sm text-primary-600 hover:underline">Theme Editor</a>
                            @if(auth()->check() && auth()->user()->isAdmin())
                                <span class="mx-2 text-neutral-300">|</span>
                                <form method="POST" action="{{ route('themes.seed') }}" class="inline">
                                    @csrf
                                    <button type="submit" class="text-sm text-primary-600 hover:underline" onclick="return confirm('Are you sure you want to re-seed themes? This will overwrite default theme configurations.')">
                                        {{ __('Reload Themes') }}
                                    </button>
                                </form>
                            @endif
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            @foreach($themes as $theme)
                                <label class="relative cursor-pointer group">
                                    ...
                                    <div class="theme-selection-card rounded-2xl p-4 transition-all peer-checked:ring-2 peer-checked:ring-offset-2 h-full flex flex-col bg-white shadow-sm border border-neutral-200">
                                        <div class="flex items-center justify-between mb-3">
                                            <div class="flex items-center gap-2">
                                                <h4 class="font-medium text-neutral-900">{{ $theme->title }}</h4>
                                            ...
                                            <div class="theme-selection-check w-4 h-4 rounded-full border-2 border-neutral-300 flex items-center justify-center">
                                                <svg class="w-2 h-2 text-white hidden peer-checked:block" fill="currentColor" viewBox="0 0 8 8">
                                                    <circle cx="4" cy="4" r="4"/>
                                                </svg>
                                            </div>
                                        </div>
                                        <p class="text-sm text-neutral-600 mb-4 flex-grow">
                                        ...
                                        <div class="mt-auto">
                                            ...
                                            <div class="text-xs text-neutral-500 mt-1">Light / Dark</div>
                                        </div>
                                    </div>
                                </label>
                            @endforeach
            ...
            <section class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <!-- Primary Colors -->
                    <div>
                        <h4 class="text-sm font-semibold text-neutral-500 mb-2">Primary Colors</h4>
                        <div class="grid grid-cols-5 gap-2">
                            <div class="space-y-1 text-center">
                                <div class="w-full h-12 rounded border" style="background-color: var(--theme-primary-50)"></div>
                                <span class="text-xs text-neutral-500">50</span>
                            </div>
                            <div class="space-y-1 text-center">
                    ...
                    <!-- Status Colors -->
                    <div>
                        <h4 class="text-sm font-semibold text-neutral-500 mb-2">Status Colors</h4>
            ...
            <section class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                        <h4 class="text-sm font-semibold text-neutral-500 mb-2">Success</h4>
                        <div class="space-y-2">
                    ...
                    <div>
                        <h4 class="text-sm font-semibold text-neutral-500 mb-2">Processing (Pulse)</h4>
                        <div class="space-y-2">
                    ...
                    <div>
                        <h4 class="text-sm font-semibold text-neutral-500 mb-2">Warning</h4>
                        <div class="space-y-2">
                    ...
                    <div>
                        <h4 class="text-sm font-semibold text-neutral-500 mb-2">Danger</h4>
                        <div class="space-y-2">
                ...
                <div class="mt-4">
                    <h4 class="text-sm font-semibold text-neutral-500 mb-2">Custom Text</h4>
            ...
            <section class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <h4 class="text-sm font-semibold text-neutral-500 mb-2">Alpine.js Binding</h4>
            ...
            <section class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="space-y-8">
                    <div>
                        <h4 class="text-sm font-semibold text-neutral-500 mb-2">Step 1</h4>
                        <x-smart-stepper :steps="$steps" :currentStep="1" />
                    </div>
                    <div>
                        <h4 class="text-sm font-semibold text-neutral-500 mb-2">Step 2</h4>
                        <x-smart-stepper :steps="$steps" :currentStep="2" />
                    </div>
                    <div>
                        <h4 class="text-sm font-semibold text-neutral-500 mb-2">Step 3</h4>
                        <x-smart-stepper :steps="$steps" :currentStep="3" />
                    </div>
                    <div>
                        <h4 class="text-sm font-semibold text-neutral-500 mb-2">Completed</h4>
            ...
            <section class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <button @click="$dispatch('open-activity-drawer')" class="bg-primary-600 text-white px-4 py-2 rounded hover:bg-primary-700">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6" x-data="{ open: false }">
                <button @click="open = !open" class="flex items-center justify-between w-full text-left">
                    <h3 class="text-lg font-bold text-neutral-900">{{ __('Legacy Theme Preview Elements') }}</h3>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            <div class="bg-neutral-50 p-4 rounded-lg border">
                                <h4 class="text-sm font-semibold text-neutral-500 uppercase tracking-wider mb-4">Typography</h4>
                                ...
                                <p class="text-neutral-600">This is a paragraph of text to demonstrate body copy. It contains <strong>bold text</strong>, <em>italic text</em>, and <a href="#" class="text-primary-600 hover:underline">links</a>.</p>
                            </div>

                            <div class="bg-neutral-50 p-4 rounded-lg border">
                                <h4 class="text-sm font-semibold text-neutral-500 uppercase tracking-wider mb-4">Buttons</h4>
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <button class="px-4 py-2 bg-neutral-600 text-white rounded hover:bg-neutral-700">Secondary</button>
                                    ...
                                    <button class="px-4 py-2 bg-white border border-neutral-300 text-neutral-700 rounded hover:bg-neutral-50">Outline</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-6">
                            <div class="bg-neutral-50 p-4 rounded-lg border">
                                <h4 class="text-sm font-semibold text-neutral-500 uppercase tracking-wider mb-4">Form Elements</h4>
                                <div class="space-y-4">
                                    <div>
                                        <label class="block text-sm font-medium text-neutral-700">Text Input</label>
                                        <input type="text" class="mt-1 block w-full rounded-md border-neutral-300 shadow-sm focus:border-primary-500 focus:ring-primary-500" placeholder="Sample text...">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-neutral-700">Select</label>
                                        <select class="mt-1 block w-full rounded-md border-neutral-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">
                                    ...
                                    <div class="flex items-center gap-4">
                                        <label class="flex items-center">
                                            <input type="checkbox" class="rounded border-neutral-300 text-primary-600 shadow-sm focus:ring-primary-500" checked>
                                            <span class="ml-2 text-sm text-neutral-600">Checkbox</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="radio" class="border-neutral-300 text-primary-600 shadow-sm focus:ring-primary-500" checked>
                                            <span class="ml-2 text-sm text-neutral-600">Radio</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-neutral-50 p-4 rounded-lg border">
                                <h4 class="text-sm font-semibold text-neutral-500 uppercase tracking-wider mb-4">Alerts</h4>
                                <div class="space-y-2">

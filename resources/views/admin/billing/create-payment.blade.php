<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            @if(session('success'))
                <div class="mb-6 bg-success-50 border-l-4 border-success-400 p-4">
                    <div class="flex">
                ...
                <div class="p-6 text-neutral-900">
                    ...
                    <form method="POST" action="{{ route('admin.billing.payments.store') }}">
                        ...
                        <div class="space-y-6">
                            <div>
                                <label for="client_id" class="block text-sm font-medium text-neutral-700 mb-2">
                                    Client <span class="text-danger-600">*</span>
                                </label>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label for="payment_date" class="block text-sm font-medium text-neutral-700 mb-2">
                            ...
                            <div>
                                <label for="payment_type" class="block text-sm font-medium text-neutral-700 mb-2">
                                    Payment Type <span class="text-danger-600">*</span>
                                </label>
                            ...
                            <div>
                                <label for="reference" class="block text-sm font-medium text-neutral-700 mb-2">
                                    Reference Number
                                </label>
                                <input type="text" 
                                       name="reference" 
                            ...
                            <div class="bg-neutral-50 p-4 rounded-lg border border-neutral-200">
                                <div class="flex items-center space-x-2 mb-3">
                                    ...
                                    <label for="set_expiration" class="text-sm font-medium text-neutral-700">Set Credit Expiration</label>
                                </div>
                                
                                <div id="expiration-fields" class="mt-2" style="display: {{ old('set_expiration') ? 'block' : 'none' }};">
                                    <label for="expiration_days" class="block text-sm font-medium text-neutral-700 mb-2">Expires in (days)</label>
                                    <input type="number" 
                                           ...
                                           placeholder="365"
                                           class="w-full border-neutral-300 rounded-lg shadow-sm focus:border-primary-500 focus:ring-primary-500">
                                    <p class="mt-1 text-xs text-neutral-500">Credit will expire after this many days from the payment date</p>
                            ...
                            <div>
                                ...
                                <textarea name="notes" 
                                          id="notes" 
                                          rows="3"
                                          class="w-full border-neutral-300 rounded-lg shadow-sm focus:border-primary-500 focus:ring-primary-500">{{ old('notes') }}</textarea>
                                @error('notes')
                                    <p class="mt-1 text-sm text-danger-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mt-6 flex justify-end gap-3">
                            <a href="{{ url()->previous() }}" 
                               class="px-4 py-2 border border-neutral-300 text-neutral-700 rounded-lg hover:bg-neutral-50">
                                Cancel
                            </a>
                            <button type="submit" 

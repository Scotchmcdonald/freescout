...
<div class="bulk-actions-toolbar bg-white border-b border-neutral-200 py-3 px-4" 
     x-data="{ 
         selected: [], 
         selectAll: false,
         showActions: false 
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
            ...
            <span class="text-sm text-neutral-500" x-show="showActions" style="display: none;">
        ...
        <div class="flex items-center gap-2" x-show="showActions" style="display: none;">
            ...
            <div class="relative" x-data="{ open: false }">
                <button type="button" 
                        @click="open = !open"
                        class="inline-flex items-center px-3 py-2 border border-neutral-300 shadow-sm text-sm font-medium rounded-md text-neutral-700 bg-white hover:bg-neutral-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
            ...
            <button type="button" 
                    ...
                    class="inline-flex items-center px-3 py-2 border border-danger-300 shadow-sm text-sm font-medium rounded-md text-danger-700 bg-white hover:bg-danger-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-danger-500">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">

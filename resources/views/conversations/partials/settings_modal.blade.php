...
<div class="modal-overlay fixed inset-0 bg-neutral-900 bg-opacity-50 z-50 hidden" 
     id="settings-modal"
     x-data="{ open: false }"
     x-show="open"
            ...
            <form method="POST" 
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <div>
                                <label class="block text-xs text-neutral-600 mb-1">{{ __('Field 1') }}</label>
                                <input type="text" 
                                       name="custom_field_1" 
                            ...
                            <div>
                                <label class="block text-xs text-neutral-600 mb-1">{{ __('Field 2') }}</label>
                                <input type="text" 
                                       name="custom_field_2" 
                    ...
                    <div>
                        ...
                        <textarea name="internal_notes" 
                                  ...
                                  class="w-full border-neutral-300 rounded-md shadow-sm focus:border-primary-500 focus:ring-primary-500">{{ old('internal_notes', $conversation->meta['internal_notes'] ?? '') }}</textarea>
                    </div>

                    {{-- Billing Section --}}
                    <div class="border-t border-neutral-200 pt-6">
                        <h4 class="text-sm font-semibold text-neutral-900 mb-4">{{ __('Billing Information') }}</h4>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center">
                                ...
                                <label for="is_billable" class="ml-2 text-sm text-neutral-700">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label for="billable_hours" class="block text-sm font-medium text-neutral-700 mb-2">
                                        {{ __('Billable Hours') }}
                                    </label>
                                    <input type="number" 
                                           name="billable_hours" 
                                ...
                                <div>
                                    <label for="billable_rate" class="block text-sm font-medium text-neutral-700 mb-2">
                                        {{ __('Billable Rate ($)') }}
                                    </label>
                                    <input type="number" 
                                           name="billable_rate" 

...
@else
    ...
    <div class="text-center py-12">
        ...
        <h3 class="mt-2 text-sm font-medium text-neutral-900">{{ __('No threads yet') }}</h3>
        <p class="mt-1 text-sm text-neutral-500">{{ __('This conversation has no messages yet.') }}</p>
    </div>
@endif

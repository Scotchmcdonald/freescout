...
<div class="move-conv-dialog p-6">
    <form method="POST" 
        ...
        <div class="space-y-6">
            ...
            {{-- Confirmation Info --}}
            <div class="border-l-4 p-4" style="background-color: var(--theme-primary-50); border-color: var(--theme-primary-400);">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm" style="color: var(--theme-primary-700);">

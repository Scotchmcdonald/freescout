                    ...
                    <form method="POST" action="{{ request()->is('helpdesk/*') ? route('helpdesk.tickets.store') : route('conversations.store', $mailbox) }}" id="conversation-form">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label for="customer_first_name" class="block text-sm font-medium text-neutral-700 mb-2">
                                        First Name
                                    </label>
                                ...
                                <div>
                                    <label for="customer_last_name" class="block text-sm font-medium text-neutral-700 mb-2">
                                        Last Name
                                    </label>
                            ...
                            <div>
                                <label for="body" class="block text-sm font-medium text-neutral-700 mb-2">
                                    @if(request()->is('helpdesk/*'))
                                        Description *
                                    @else
                                        Message *
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label for="assign_to" class="block text-sm font-medium text-neutral-700 mb-2">
                                        Assign To
                                    </label>
                            ...
                            @if(request()->is('helpdesk/*'))
                                ...
                                <div class="border-t border-neutral-200 pt-6">
                                    <h3 class="text-lg font-medium text-neutral-900 mb-4">Billing Information</h3>
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <label for="hourly_rate" class="block text-sm font-medium text-neutral-700 mb-2">
                                                    Hourly Rate
                                                </label>

...
<div x-data="{
    ...
    <div class="flex items-center gap-2">
        <select 
            class="border-neutral-300 rounded-md text-sm focus:border-primary-500 focus:ring focus:ring-primary-200 focus:ring-opacity-50"
            x-model="status"
        ...
        <span x-show="loading" x-cloak class="text-sm text-neutral-500 flex items-center">

<div>
    @if(auth()->check() && method_exists(auth()->user(), 'isImpersonated') && auth()->user()->isImpersonated())
        ...
        <div
            ...
            class="bg-warning-100 border-b-4 border-warning-500 px-6 py-3 shadow-lg sticky top-0 z-[9999]"
        >
            <div class="max-w-7xl mx-auto flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-warning-700">
                            ...
                            <span
                                x-text="formatted"
                                :class="isUrgent ? 'text-danger-700 font-bold' : 'font-semibold'"
                            ></span>
                        </p>
                    </div>
                </div>
                <div class="flex items-center space-x-3 flex-shrink-0">
                    ...
                    <a
                        ...
                        class="text-xs text-warning-700 underline hover:text-warning-900"
                    >
                        Emergency exit
                    </a>
                    ...
                    <form method="POST" action="{{ route('impersonate.leave') }}">
                        @csrf
                        <button type="submit" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-warning-600 hover:bg-warning-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-warning-500 transition-colors">

...
<body bgcolor="#ffffff">
    <div id="fsReplyAbove" class="fsReplyAbove">
    ...
    <span height="0" style="font-size: 0px; height:0px; line-height: 0px; color:#ffffff;">{{ isset($headers['Message-ID']) ? $headers['Message-ID'] : '' }}</span>
</body>
</html>

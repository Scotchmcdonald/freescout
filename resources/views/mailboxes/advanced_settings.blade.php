            ...
            <form method="POST" action="{{ route('mailboxes.save_advanced_settings', $mailbox) }}" class="space-y-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-neutral-900">
                        ...
                        <div class="mb-4">
                            <label for="aliases" class="block text-sm font-medium text-neutral-700">Aliases</label>
                            <textarea 
                                id="aliases" 
                                name="aliases" 
                                rows="4" 
                        ...
                        <div class="mb-4">
                            <label class="flex items-center">
                                <input 
                                    ...
                                    class="rounded border-neutral-300 text-primary-600 shadow-sm focus:border-primary-500 focus:ring focus:ring-primary-500 focus:ring-opacity-50">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-neutral-900">
                            ...
                            @foreach($fromNameOptions as $value => $label)
                                <label class="flex items-center">
                                    <input 
                                        ...
                                        class="border-neutral-300 text-primary-600 shadow-sm focus:border-primary-500 focus:ring focus:ring-primary-500 focus:ring-opacity-50"
                        ...
                        <div id="custom_from_name_field" class="mb-4 {{ ($mailbox->from_name ?? 1) == 4 ? '' : 'hidden' }}">
                            <label for="from_name_custom" class="block text-sm font-medium text-neutral-700">Custom Name</label>
                            <input 
                                type="text" 
                                id="from_name_custom" 
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-neutral-900">
                        ...
                        <div class="mb-4">
                            <label for="ticket_assignee" class="block text-sm font-medium text-neutral-700">Default Assignee for New Tickets</label>
                            <select 
                                id="ticket_assignee" 
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-neutral-900">
                        ...
                        <div class="mb-4">
                            <label for="before_reply" class="block text-sm font-medium text-neutral-700">Before Reply/Forward</label>
                            <textarea 
                                id="before_reply" 
                                name="before_reply" 
                                rows="3" 
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-neutral-900">
                        ...
                        <div class="mb-4">
                            <label for="signature" class="block text-sm font-medium text-neutral-700">Email Signature</label>
                            <textarea 
                                id="signature" 
                                name="signature" 
                                rows="6" 

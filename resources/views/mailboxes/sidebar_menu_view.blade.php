        ...
        <div class="p-4 border-t border-neutral-200 space-y-2">
            ...
            @if ($show_settings_btn)
                <div class="relative">
                    ...
                    {{-- Settings Dropdown --}}
                    <div class="hidden absolute bottom-full mb-2 w-full bg-white rounded-md shadow-lg border border-neutral-200 z-10">
                        @if (Auth::user()->hasAdminAccess())
                            <a href="{{ route('mailboxes.settings', $mailbox) }}" 
                               class="block px-4 py-2 text-sm text-neutral-700 hover:bg-neutral-50 rounded-t-md">
                        ...
                        <a href="{{ route('mailboxes.auto_reply', $mailbox) }}" 
                           class="block px-4 py-2 text-sm text-neutral-700 hover:bg-neutral-50 rounded-b-md">
                            <svg class="inline-block mr-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">

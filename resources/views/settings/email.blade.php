        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-col md:flex-row">
            ...
            <div class="flex-1 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-neutral-900">
                    ...
                    <div class="mb-6 border-l-4 p-4" style="background-color: var(--theme-status-info-bg); border-color: var(--theme-status-info-bg)">
                        <p class="text-sm" style="color: var(--theme-status-info-text)">
                    ...
                    <form method="POST" action="{{ route('settings.email.update') }}">
                        ...
                        <div class="space-y-6">
                            <div>
                                <label for="mail_driver" class="block text-sm font-medium text-neutral-700 mb-2">
                                    {{ __('Mail Driver') }} *
                                </label>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label for="mail_from_address" class="block text-sm font-medium text-neutral-700 mb-2">
                                        {{ __('From Email') }} *
                                    </label>
                                ...
                                <div>
                                    <label for="mail_from_name" class="block text-sm font-medium text-neutral-700 mb-2">
                                        {{ __('From Name') }} *
                                    </label>
                            ...
                            <div class="border-t border-neutral-200 pt-6">
                                <h3 class="text-lg font-medium text-neutral-900 mb-4">{{ __('SMTP Settings') }}</h3>
                                
                                <div class="space-y-4">
                                    <div>
                                        <label for="mail_host" class="block text-sm font-medium text-neutral-700 mb-2">
                                            {{ __('SMTP Host') }}
                                        </label>
                                    ...
                                    <div class="grid grid-cols-3 gap-4">
                                        <div>
                                            <label for="mail_port" class="block text-sm font-medium text-neutral-700 mb-2">
                                                {{ __('SMTP Port') }}
                                            </label>
                                        ...
                                        <div class="col-span-2">
                                            <label for="mail_encryption" class="block text-sm font-medium text-neutral-700 mb-2">
                                                {{ __('Encryption') }}
                                            </label>
                                    ...
                                    <div>
                                        <label for="mail_username" class="block text-sm font-medium text-neutral-700 mb-2">
                                            {{ __('SMTP Username') }}
                                        </label>
                                    ...
                                    <div>
                                        <label for="mail_password" class="block text-sm font-medium text-neutral-700 mb-2">
                                            {{ __('SMTP Password') }}
                                        </label>
                                        <input type="password" name="mail_password" id="mail_password"
                                               value="{{ old('mail_password', $settings['mail_password'] ?? '') }}"
                                               class="w-full border-neutral-300 rounded-md shadow-sm focus:border-primary-500 focus:ring-primary-500">
                                        <p class="mt-1 text-sm text-neutral-500">Leave blank to keep current password</p>
                                    </div>
                                </div>
                            </div>
                        </div>

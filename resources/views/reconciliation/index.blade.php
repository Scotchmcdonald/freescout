    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div @click="activeFilter = 'all'" 
                 ...
                 class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-blue-500 cursor-pointer hover:bg-blue-50 transition-colors">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <div @click="activeFilter = 'success'" 
                 :class="{ 'bg-green-50': activeFilter === 'success' }"
                 class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-green-500 cursor-pointer hover:bg-green-50 transition-colors">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <div @click="activeFilter = 'critical'" 
                 :class="{ 'bg-red-50': activeFilter === 'critical' }"
                 class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-red-500 cursor-pointer hover:bg-red-50 transition-colors">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <div @click="activeFilter = 'pending'" 
                 :class="{ 'bg-yellow-50': activeFilter === 'pending' }"
                 class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-yellow-500 cursor-pointer hover:bg-yellow-50 transition-colors">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">Need manual review</p>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200">
            @if($runs->isEmpty())
                ...
                <div class="text-center py-12" role="status" aria-live="polite">
                    ...
                    <h3 class="mt-4 text-lg font-medium text-gray-900">No reconciliation runs yet</h3>
                    <p class="mt-2 text-sm text-gray-600">
                        Start your first reconciliation to check for asset discrepancies
                    </p>
                    <button 
                        onclick="document.getElementById('triggerModal').classList.remove('hidden')"
                        class="mt-4 inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-md text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                                ...
                                <tr role="row"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if($run->success_rate !== null)
                                            ...
                                            <div class="w-full bg-gray-200 rounded-full h-1.5 mt-1">
                                                @php
                                                    $barColor = $run->success_rate >= 95 ? 'bg-green-500' : 
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('reconciliation.show', $run) }}" 
                                           class="inline-flex items-center px-3 py-1 text-indigo-600 hover:bg-indigo-50 rounded-lg text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
...
<div id="triggerModal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 z-50 flex items-center justify-center" role="dialog" aria-modal="true" aria-labelledby="triggerModalTitle">
    <div class="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        <form action="{{ route('reconciliation.trigger') }}" method="POST" id="triggerForm">
            @csrf
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 id="triggerModalTitle" class="text-lg font-semibold text-gray-900">
                    Run Reconciliation
                </h3>
            </div>
            <div class="px-6 py-4">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div class="flex">
                        <svg class="h-5 w-5 text-blue-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div class="px-6 py-4 border-t border-gray-200 flex justify-end space-x-3">
                <button 
                    ...
                    class="px-4 py-2 bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 rounded-md text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                    Cancel
                </button>
                <button 

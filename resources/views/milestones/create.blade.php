                    ...
                    <form method="POST" action="{{ route('milestones.store') }}" class="space-y-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label for="total-value" class="block text-sm font-medium text-neutral-700 mb-2">
                                        {{ __('Total Value') }}
                                    </label>
                                    <input type="number" 
                                           name="total-value" 
                                ...
                                <div>
                                    <label for="billing-type" class="block text-sm font-medium text-neutral-700 mb-2">
                                        {{ __('Billing Type') }}
                                    </label>
                            ...
                            <div class="mt-4">
                                <label class="flex items-center">
                                    <input type="checkbox" name="require_approval" dusk="require-milestone-approval" class="rounded border-neutral-300 text-primary-600 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
                                    <span class="ml-2 text-sm text-neutral-600">{{ __('Require Milestone Approval') }}</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="border-t border-neutral-200 pt-6">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-lg font-medium text-neutral-900">{{ __('Milestones') }}</h3>
                                <button type="button" 
                        ...
                        <!-- Basic Information -->
                        <div class="space-y-6 border-t border-neutral-200 pt-6">
                            <div>
                ...
                <div class="grid grid-cols-3 gap-3">
                    <div>
                        <input type="text" 
                               ...
                               class="w-full border-neutral-300 rounded shadow-sm"

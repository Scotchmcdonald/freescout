...
class UpdateFolderCountersCommandTest extends TestCase
{
    ...
    public function test_update_folder_counters_command_has_expected_contract(): void
    {
        /** @var UpdateFolderCounters $command */
        $command = $this->app->make(UpdateFolderCounters::class);

        $this->assertSame('freescout:update-folder-counters', $command->getName());
        $this->assertSame('Update counters for all folders', $command->getDescription());
    }

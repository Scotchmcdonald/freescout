...
class UserNotificationTest extends IntegrationTestCase
{
    ...
    public function test_envelope_contains_conversation_number_in_subject(): void
    {
        $user = User::factory()->create();
        $mailbox = Mailbox::factory()->create();
    ...
    public function test_envelope_uses_custom_from_address(): void
    {
        $user = User::factory()->create();
        $mailbox = Mailbox::factory()->create();
        $conversation = Conversation::factory()->create(['mailbox_id' => $mailbox->id]);
    ...
    public function test_content_uses_notification_views(): void
    {
        $user = User::factory()->create();
        $mailbox = Mailbox::factory()->create();
        $conversation = Conversation::factory()->create(['mailbox_id' => $mailbox->id]);
    ...
    public function test_content_includes_customer_thread_and_mailbox(): void
    {
        $user = User::factory()->create();
        $mailbox = Mailbox::factory()->create();
    ...
    public function test_build_method_sets_custom_headers(): void
    {
        $user = User::factory()->create();
        $mailbox = Mailbox::factory()->create();
    ...
    public function test_build_includes_all_view_data(): void
    {
        $user = User::factory()->create();
        $mailbox = Mailbox::factory()->create();
        $conversation = Conversation::factory()->create(['mailbox_id' => $mailbox->id]);

...
class UserNotificationMailTest extends IntegrationTestCase
{
    ...
    public function test_envelope_uses_custom_from_address_when_provided(): void
    {
        ...
        $mailable = new UserNotification($user, $conversation, $threads, $mailbox, [], $fromAddress);
        $envelope = $mailable->envelope();
    ...
    public function test_mailable_stores_all_properties(): void
    {
        ...
        $mailable = new UserNotification($user, $conversation, $threads, $mailbox, $headers, $fromAddress);

...
class ConversationFolderTest extends UnitTestCase
{

    public function test_conversation_folder_can_be_created(): void
    {
    ...
    public function test_conversation_folder_is_a_pivot_model(): void
    {
    ...
    public function test_conversation_folder_uses_correct_table(): void
    {
        $conversationFolder = new ConversationFolder();
    ...
    public function test_conversation_folder_has_timestamps(): void
    {
        $conversationFolder = new ConversationFolder();
    ...
    public function test_conversation_folder_has_fillable_attributes(): void
    {
        $conversationFolder = new ConversationFolder();
    ...
    public function test_conversation_folder_casts_conversation_id_to_integer(): void
    {
        $conversation = Conversation::factory()->create();
        $folder = Folder::factory()->create();
    ...
    public function test_conversation_folder_casts_folder_id_to_integer(): void
    {
        $conversation = Conversation::factory()->create();
        $folder = Folder::factory()->create();
    ...
    public function test_conversation_folder_casts_timestamps(): void
    {
        $conversation = Conversation::factory()->create();
        $folder = Folder::factory()->create();
    ...
    public function test_conversation_folder_can_be_moved_to_different_folder(): void
    {
        $conversation = Conversation::factory()->create();
    ...
    public function test_conversation_folder_can_be_deleted(): void
    {
        $conversation = Conversation::factory()->create();
        $folder = Folder::factory()->create();
    ...
    public function test_multiple_conversation_folders_can_exist(): void
    {
    ...
    public function test_conversation_folder_records_creation_time(): void
    {
        $conversation = Conversation::factory()->create();
        $folder = Folder::factory()->create();
    ...
    public function test_conversation_folder_records_update_time(): void
    {
        $conversation = Conversation::factory()->create();
        $folder1 = Folder::factory()->create();
        $folder2 = Folder::factory()->create();
    ...
    public function test_conversation_folder_can_be_queried_by_conversation_id(): void
    {
        $conversation1 = Conversation::factory()->create();
        $conversation2 = Conversation::factory()->create();
        $folder1 = Folder::factory()->create();
    ...
    public function test_conversation_folder_can_be_queried_by_folder_id(): void
    {
        $conversation1 = Conversation::factory()->create();
        $conversation2 = Conversation::factory()->create();

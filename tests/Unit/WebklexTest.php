...
class WebklexTest extends FixtureWebklexMessage
{
     ...
     * @throws MaskNotFoundException
     */
    public function test_message1_b()
    {
     ...
     * @throws MaskNotFoundException
     */
    public function test_message1_symbols()
    {
    ...
    public function test_message_parts()
    {
    ...
    public function test_issue4567()
    {
    ...
    public function test_regular_email()
    {

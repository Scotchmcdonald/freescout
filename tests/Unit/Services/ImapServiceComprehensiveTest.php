...
class ImapServiceComprehensiveTest extends UnitTestCase
{
    ...
    */
    ...
    // ===== BASIC IMAP SERVICE TESTS (Merged from ImapServiceTest.php) =====

    public function test_imap_service_fetch_emails_returns_array_with_no_server(): void
    {
        $mailbox = new Mailbox([
            'id' => 1,
            'name' => 'Test Mailbox',
    ...
    public function test_imap_service_fetch_emails_method_exists(): void
    {
        $service = new ImapService;

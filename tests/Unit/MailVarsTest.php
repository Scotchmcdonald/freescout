...
class MailVarsTest extends TestCase
{
    ...
    public function replace_mail_vars(
        ...
        $actual = MailHelper::replaceMailVars($inputText, $data, $escape, $removeNonReplaced);
        $this->assertEquals(
    ...
    public function has_vars(): void
    {
        ...
        $this->assertFalse(MailHelper::hasVars('No variables here'));
    ...
    public function simple_variable_replacement(): void
    {
        ...
        $expected = 'Hello Jeffrey Lebowski!';
    ...
    public function remove_non_replaced_variables(): void
    {
        ...
        $this->assertStringContainsString('{%customer.email%}', $result);

        // With removal, variables are removed
        $result = MailHelper::replaceMailVars($text, [], false, true);
        $this->assertStringNotContainsString('{%customer.fullName%}', $result);
        $this->assertStringNotContainsString('{%customer.email%}', $result);
        $this->assertEquals('Hello , your email is', $result);
    }
}

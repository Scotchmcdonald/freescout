...
class CircuitBreaker
{
    ...
    {
        $this->failureThreshold = config('services.circuit_breaker.threshold', 5);
        $this->recoveryTimeout = config('services.circuit_breaker.timeout', 60);
    }
     ...
     * 
     * @return array Array of service states
     */

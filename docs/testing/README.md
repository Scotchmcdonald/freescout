...
- `docs/testing/CI_LANES_ARCHITECTURE.md` — lane design, dependencies, artifacts
- `docs/testing/CI_GUARD_STAGES.md` — architecture/isolation guard behavior and fixes

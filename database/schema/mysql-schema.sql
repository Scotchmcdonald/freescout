...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `cm_billing_template_line_items`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cm_billing_template_line_items` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `billing_template_id` bigint(20) unsigned NOT NULL,
  ...
  `product_config` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`product_config`)),
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cm_billing_template_line_items_billing_template_id_index` (`billing_template_id`),
  CONSTRAINT `cm_billing_template_line_items_billing_template_id_foreign` FOREIGN KEY (`billing_template_id`) REFERENCES `cm_billing_templates` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `cm_billing_templates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cm_billing_templates` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `client_id` bigint(20) unsigned NOT NULL,
  `contract_id` bigint(20) unsigned DEFAULT NULL,
  `name` varchar(255) NOT NULL,
  `product_type` enum('service_plan','rent_to_own','ad_hoc','software','hardware','labor','one_time') NOT NULL DEFAULT 'service_plan',
  ...
  `status` enum('active','paused','terminated','completed') NOT NULL DEFAULT 'active',
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cm_billing_templates_next_invoice_date_status_index` (`next_invoice_date`,`status`),
  KEY `cm_billing_templates_client_id_status_index` (`client_id`,`status`),
  KEY `cm_billing_templates_contract_id_index` (`contract_id`),
  CONSTRAINT `cm_billing_templates_client_id_foreign` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`) ON DELETE CASCADE,
  CONSTRAINT `cm_billing_templates_contract_id_foreign` FOREIGN KEY (`contract_id`) REFERENCES `cm_contracts` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `cm_contract_schedules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cm_contract_schedules` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `contract_id` bigint(20) unsigned NOT NULL,
  `schedule_type` enum('billing','renewal','review') NOT NULL DEFAULT 'billing',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cm_contract_schedules_next_date_schedule_type_is_active_index` (`next_date`,`schedule_type`,`is_active`),
  KEY `cm_contract_schedules_contract_id_index` (`contract_id`),
  CONSTRAINT `cm_contract_schedules_contract_id_foreign` FOREIGN KEY (`contract_id`) REFERENCES `cm_contracts` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cm_contracts` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `cm_contracts_contract_number_unique` (`contract_number`),
  KEY `cm_contracts_quote_id_foreign` (`quote_id`),
  KEY `cm_contracts_signed_by_foreign` (`signed_by`),
  KEY `cm_contracts_client_id_status_index` (`client_id`,`status`),
  KEY `cm_contracts_contract_number_index` (`contract_number`),
  KEY `cm_contracts_end_date_status_index` (`end_date`,`status`),
  CONSTRAINT `cm_contracts_client_id_foreign` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`) ON DELETE CASCADE,
  CONSTRAINT `cm_contracts_quote_id_foreign` FOREIGN KEY (`quote_id`) REFERENCES `cm_quotes` (`id`) ON DELETE SET NULL,
  CONSTRAINT `cm_contracts_signed_by_foreign` FOREIGN KEY (`signed_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `cm_quote_line_items`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cm_quote_line_items` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `quote_id` bigint(20) unsigned NOT NULL,
  `description` varchar(255) NOT NULL,
  `quantity_type` enum('fixed','per_user','per_asset') NOT NULL DEFAULT 'fixed',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cm_quote_line_items_quote_id_index` (`quote_id`),
  CONSTRAINT `cm_quote_line_items_quote_id_foreign` FOREIGN KEY (`quote_id`) REFERENCES `cm_quotes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `cm_quote_revisions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cm_quote_revisions` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `quote_id` bigint(20) unsigned NOT NULL,
  ...
  `revised_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `cm_quote_revisions_quote_id_revision_number_unique` (`quote_id`,`revision_number`),
  KEY `cm_quote_revisions_revised_by_foreign` (`revised_by`),
  KEY `cm_quote_revisions_quote_id_index` (`quote_id`),
  CONSTRAINT `cm_quote_revisions_quote_id_foreign` FOREIGN KEY (`quote_id`) REFERENCES `cm_quotes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `cm_quote_revisions_revised_by_foreign` FOREIGN KEY (`revised_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `cm_quotes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cm_quotes` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` bigint(20) unsigned DEFAULT NULL,
  `client_id` bigint(20) unsigned NOT NULL,
  `quote_number` varchar(255) NOT NULL,
  `title` varchar(255) DEFAULT NULL,
  `status` enum('draft','sent','approved','rejected','expired','revised','under_review') DEFAULT 'draft',
  `rejection_reason` text DEFAULT NULL,
  `subtotal` decimal(12,2) NOT NULL DEFAULT 0.00,
  `tax_amount` decimal(12,2) NOT NULL DEFAULT 0.00,
  `total` decimal(12,2) NOT NULL DEFAULT 0.00,
  `billing_type` enum('monthly','quarterly','annual','one_time','usage_based') NOT NULL DEFAULT 'monthly',
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `cm_quotes_quote_number_unique` (`quote_number`),
  KEY `cm_quotes_created_by_foreign` (`created_by`),
  KEY `cm_quotes_approved_by_foreign` (`approved_by`),
  KEY `cm_quotes_client_id_status_index` (`client_id`,`status`),
  KEY `cm_quotes_quote_number_index` (`quote_number`),
  KEY `cm_quotes_parent_id_foreign` (`parent_id`),
  CONSTRAINT `cm_quotes_approved_by_foreign` FOREIGN KEY (`approved_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `cm_quotes_client_id_foreign` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`) ON DELETE CASCADE,
  CONSTRAINT `cm_quotes_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `cm_quotes_parent_id_foreign` FOREIGN KEY (`parent_id`) REFERENCES `cm_quotes` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (42,'2026_01_16_000001_create_contract_manager_tables',1);
